        ...
        <Metrics>
            {ramData.length > 0 ? (
                <div>
                    ...
                    <MetricChart
                        data={{
                            labels: ramData.map((r) =>
                                r.time.toLocaleTimeString("pt-br"),
                            ),
                            datasets: [
                                {
                ...
                <SubscribeButton onClick={onClickRam} type="submit">
                    Obter dados de RAM
                </SubscribeButton>
            )}
            ...
            {cpuData.length > 0 ? (
                <div>
                    ...
                    <MetricChart
                        data={{
                            labels: cpuData.map((c) =>
                                c.time.toLocaleTimeString("pt-br"),
                            ),
                            datasets: [
                                {
                ...
                <SubscribeButton onClick={onClickCpu} type="submit">
                    Obter dados de CPU
                </SubscribeButton>
            )}
            ...
            {indices?.length > 0 ? (
                <div>
                    <MetricChart
                        data={{
                            labels: indices[1].indices.map((ind) =>
                                new Date(ind.tinicial).toLocaleTimeString(
                                    "pt-br",
                                ),
                            ),
                ...
                <SubscribeButton onClick={onIndices} type="submit">
